...
class TestAudioModelsContract:
    ...
    def test_audio_document_class_exists(self):
        ...
        from audio_processor import AudioDocument
    ...
    def test_audio_document_fields(self):
        ...
        expected_fields = ['file_path', 'format', 'duration', 'sample_rate',
                          'file_size', 'channels']
    ...
    def test_transcription_result_fields(self):
        ...
        expected_fields = ['audio_path', 'text', 'confidence_score',
                          'processing_time', 'model_used', 'quantization',
                          'detected_language', 'success', 'error_message']
        for field in expected_fields:
            assert field in field_names, f"Missing field: {field}"

    def test_transcription_config_class_exists(self):
        """Test that TranscriptionConfig class exists."""
        from audio_processor import TranscriptionConfig
    ...
    def test_transcription_config_fields(self):
        ...
        expected_fields = ['model', 'quantization', 'batch_size', 'language',
    ...
    def test_processing_result_fields(self):
        ...
        expected_fields = ['success', 'results', 'total_files', 'successful_count',
                          'failed_count', 'total_processing_time',
                          'average_processing_time', 'error_summary']
        for field in expected_fields:
            assert field in field_names, f"Missing field: {field}"
