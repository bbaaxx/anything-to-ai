...
class TestAudioExceptionsContract:
    ...
    def test_audio_not_found_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, AudioNotFoundError
    ...
    def test_unsupported_format_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, UnsupportedFormatError
    ...
    def test_corrupted_audio_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, CorruptedAudioError
    ...
    def test_transcription_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, TranscriptionError
    ...
    def test_no_speech_detected_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, NoSpeechDetectedError
    ...
    def test_duration_exceeded_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, DurationExceededError
    ...
    def test_processing_timeout_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, ProcessingTimeoutError
    ...
    def test_processing_interrupted_error_exists(self):
        ...
        from anyfile_to_ai.audio_processor import AudioProcessingError, ProcessingInterruptedError
