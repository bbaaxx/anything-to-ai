...
def test_submodules_importable():
    ...
    for module_name in submodules:
        try:
            ...
            assert "No module named" not in str(e) or "anyfile_to_ai" not in str(e), f"Module {module_name} should be importable or fail due to dependencies, not structure"
...
def test_cli_modules_importable():
    ...
    for module_name in cli_modules:
        try:
            ...
            # Import might fail due to missing optional dependencies
            # but the module structure should exist
            assert "No module named" not in str(e) or "anyfile_to_ai" not in str(e), f"CLI module {module_name} should be importable or fail due to dependencies, not structure"
