...
class TestModelConfigurationIntegration:
    ...
    def test_timeout_configuration_from_environment(self):
        ...
        env_vars = {"VISION_MODEL": "google/gemma-3-4b", "VLM_TIMEOUT_SECONDS": "30"}
    ...
    def test_auto_download_configuration(self):
        ...
        env_vars = {"VISION_MODEL": "google/gemma-3-4b", "VLM_AUTO_DOWNLOAD": "false"}
    ...
    def test_timeout_seconds_range_validation(self):
        ...
        # Test minimum bound
        env_vars = {"VISION_MODEL": "google/gemma-3-4b", "VLM_TIMEOUT_SECONDS": "0"}
    ...
    def test_invalid_boolean_values(self):
        ...
        env_vars = {"VISION_MODEL": "google/gemma-3-4b", "VLM_AUTO_DOWNLOAD": "maybe"}
