...
from progress_tracker import CallbackProgressConsumer, ProgressEmitter
...
class TestModuleIntegration:
    ...
    def test_progress_deprecation_warnings(self):
        ...
        modules_to_check = ["pdf_extractor.progress", "image_processor.progress", "audio_processor.progress"]
    ...
    def test_text_summarizer_progress_module_exists(self):
        ...
        try:
            from text_summarizer import progress
    ...
    def test_legacy_progress_removed(self):
        ...
        try:
            import image_processor.progress
        ...
        try:
            import audio_processor.progress
